        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    label _("Tempo de Passar Texto Automaticamente")
...
screen keyboard_help():
    ...
    hbox:
        label _("Enter")
        text _("Passa a conversa e ativa a interface.")
    ...
    hbox:
        label _("Ctrl")
        text _("Pula o dialógo enquanto apertado.")

    hbox:
        label _("Tab")
        text _("Alterna a opção de pular diálogo.")
    ...
    hbox:
        label _("Page Down")
        text _("Pula para o próximo diálogo.")
    ...
    hbox:
        label "V"
        text _("Alterna a opção de assistência {a=https://www.renpy.org/l/voicing}self-voicing{/a}.")
...
screen mouse_help():
    ...
    hbox:
        label _("Bolinha do Mouse pra Cima")
        text _("Volta pro diálogo anterior.")

    hbox:
        label _("Bolinha do Mouse pra Baixo")
        text _("Avança pro próximo diálogo.")
